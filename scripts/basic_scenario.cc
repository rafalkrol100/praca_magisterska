...
int main(int argc, char *argv[])
{
    ...
    ifTraceFile.open("../../src/lte/model/fading-traces/fading_trace_EPA_3kmph(3sec_100RBs).fad", std::ifstream::in);
    if (ifTraceFile.good())
    {
        // script launched by test.py
        lteHelper->SetFadingModelAttribute("TraceFilename", StringValue("../../src/lte/model/fading-traces/fading_trace_EPA_3kmph(3sec_100RBs).fad"));
    }
    else
    {
    ...
    std::string cellRadiusStringMultiplied = std::to_string(cellRadius * radiusMultiplier);
